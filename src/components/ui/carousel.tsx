...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className="flex gap-0" style={{ backfaceVisibility: 'hidden' }} {...props} />
  )
)
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant="outline"
        size="icon"
        className={cn('absolute left-2 top-1/2 h-10 w-10 -translate-y-1/2 rounded-full border-neutral-200 dark:border-neutral-700', className)}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant="outline"
        size="icon"
        className={cn('absolute right-2 top-1/2 h-10 w-10 -translate-y-1/2 rounded-full border-neutral-200 dark:border-neutral-700', className)}
