  ...
  return (
    <Card>
      <CardContent className="flex flex-row items-start gap-4 p-5">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-500/10 text-primary-600 dark:bg-primary-500/20 dark:text-primary-400" aria-hidden>
        ...
        <div className="min-w-0 flex-1">
          ...
          {href ? (
            ...
            <p className="mt-0.5 truncate text-neutral-900 dark:text-neutral-100">{info}</p>
          )}
        </div>
      </CardContent>
    </Card>
